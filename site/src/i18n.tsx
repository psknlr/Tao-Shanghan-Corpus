...
const DICT = {
  ...
  'dq.sub': [
    ...
    '计算验证已完成，可由本仓库 code/ 目录复现。人工审核为独立阶段，目前仍在进行，并如实标注。',
  ...
  'dq.review.title': ['Manual review', '人工审核', '人工審核'],
  'dq.review.status': ['In progress', '进行中', '進行中'],
  'dq.review.requiring': ['Structured records requiring review', '待审核结构化记录', '待審核結構化記錄'],
  'dq.review.done': ['Records reviewed', '已审核记录', '已審核記錄'],
  'dq.review.agreement': ['Agreement statistics', '一致性统计', '一致性統計'],
  ...
  'ac.cite.sub': [
    'Cite the dataset as follows. A machine-readable CITATION.cff is included in the repository.',
    '请按以下方式引用本数据集。仓库内含机器可读的 CITATION.cff。',
    '請按以下方式引用本數據集。倉庫內含機器可讀的 CITATION.cff。',
  ],
